...
- Your login: is mfwsuser22@demo.broadcom.com
...
- Your userid is CUST022.
- Your password CUST022.
...
- Run the following commands and ensure we get a 0000 return code:
  - `zowe endevor generate DOGGOS22 --type COBOL --os --maxrc 0 --sn 1 --cb`
  - `zowe endevor generate DOGGOS22 --type LNK --os --maxrc 0 --sn 1 --cb`
...
- To execute the application and see the output, we can call `zowe jobs`.
  - `zowe jobs submit dataset CUST022.PUBLIC.JCL(NDRUNDOG) --vasc`
...
`zowe jobs submit data-set "CUST022.MARBLES.JCL(MARBCOPY)" --vasc`
...
Username: _JENKINSCUST022
Password: Mfuser22@26
...
The repository URL will be `https://github.com/McQuitty-Broadcom/Python-DevOps-22.git`
